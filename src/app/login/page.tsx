...
function LoginContent() {
    ...
    const [durations, setDurations] = useState(() =>
        Array.from({ length: 36 }, (_, i) => 20 + (i % 10))
    );

    useEffect(() => {
        const nextDurations = Array.from({ length: 36 }, () => {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background">
            ...
            >
                <Card className="backdrop-blur-md bg-card/90 border-orange-500/20 shadow-xl">
                    ...
                    <CardContent className="pt-6">
                        <Button
                            ...
                            className="w-full bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-600/20 py-6 text-base font-medium transition-all hover:scale-[1.02]"
                        >
